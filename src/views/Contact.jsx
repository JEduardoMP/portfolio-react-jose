    ...
    return(
        <section className="text-center w-full">
            ...
            <form action="" className="flex justify-center aling-center flex-col md:grid md:grid-cols-2 md:gap-3 lg:grid-cols-3">
                <div className="w-full flex flex-col text-center mb-8">
                    <label htmlFor="">Name <span className="text-red font-bold w-full">*</span></label>
                    <input type="text" name="" id=""  className="p-2 text-center" required/>
                </div>

                <div className="w-full flex flex-col text-center mb-8">
                        <label htmlFor="">Email <span className="text-red font-bold">*</span></label>
                        <input type="email" name="" id=""  className="p-2 text-center" required/>
                </div>

                <div className="w-full flex flex-col text-center mb-8">
                    <label htmlFor="">Subject <span className="text-red font-bold">*</span></label>
                    <input type="text" name="Subject" id=""  className="p-2 text-center" required/>
                </div>

                <div className="w-full flex flex-col text-center md:col-start-1 md:col-end-3 lg:col-start-1 lg:col-end-4">
                    <label htmlFor="">Message <span className="text-red font-bold">*</span></label>
                    <textarea type="text" name="" id=""  className="p-8"/>
                </div>
