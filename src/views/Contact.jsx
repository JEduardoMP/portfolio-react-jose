        ...
        <section className="text-gray-600 body-font relative px-5 w-full">
            ...
            <div className="container py-24 mx-auto flex sm:flex-nowrap flex-wrap">
                ...
                <div className="bg-primary lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                    ...
                    <form action="mailto:eduardomarque2009@gmail.com" method="POST" enctype="text/plain">
                        <div className="relative mb-4">
                            <label for="boxName" className="leading-7 text-sm text-gray-600">Name</label>
                            <input type="text" id="boxName" name="boxName" className="w-full bg-white rounded border border-gray-300 focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                        </div>
                        <div className="relative mb-4">
