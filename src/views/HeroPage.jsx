...
const HeroPage = () => {
    ...
    return (
        <section className="text-gray-600 body-font pt-16 max-w-full md:pt-12">
            <div className="container mx-auto flex px-5 pb-8 pt-24 md:flex-row flex-col items-center">
                <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Hello there! I'm Jose Eduardo
                    <br />
                    </h1>
