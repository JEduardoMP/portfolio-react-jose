        ...
        <section className="text-gray-600 body-font py-24" id="portfolio">
            ...
            <div className="container px-5 pb-24 mx-auto">
                ...
                <div className="p-4 md:w-1/3">
                    ...
                    <img className="lg:h-48 md:h-36 w-full object-cover object-center" src="https://d33wubrfki0l68.cloudfront.net/61986af6be45425f8f42b45f/screenshot_2021-11-20-03-28-15-0000.png" alt="Dashboard" />
                    <div className="p-6">
                ...
                <div className="p-4 md:w-1/3">
                    <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                    <img className="lg:h-48 md:h-36 w-full object-cover object-center" src="https://d33wubrfki0l68.cloudfront.net/616622dbd015b300089ae605/screenshot_2021-10-13-00-06-39-0000.png" alt="blog" />
                        <div className="p-6">
                            <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">CATEGORY</h2>
                ...
                <div className="p-4 md:w-1/3">
                    <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                    <img className="lg:h-48 md:h-36 w-full object-cover object-center" src={triviaImg} alt="Trivia" />
                    <div className="p-6">
                        <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">CATEGORY</h2>
